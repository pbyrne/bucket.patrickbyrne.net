...
module.exports = class BucketImage {
  ...
  async processImage({widths} = {}) {
    ...
    console.log({name: this.originalName, processorOptions: this.processorOptions({widths})})
    const urlPath = "/images/"
    const buildDir = "_site"

    return EleventyImage(this.originalUrl, this.processorOptions({widths}))
  }
